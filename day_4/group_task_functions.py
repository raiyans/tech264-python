...
"""
# def print_something(string_value="empty"):
#     print(string_value)
# print_something("raiyan")
...
"""
# def greet(string_value="empty"):
#     print(f"Hello, my name is {string_value}")
# greet("Susan")
...
#
# print(addition(2, 2))
# # you need to have  the return keyword if you want the function to return a value
...
#     return int1 + int2
#
# print(addition()) # answer is 2
# print(addition(4, 4)) #answer is 8
...
"""
# def print_every_number(value=()):
#     print(type(value))
#     for item in value:
#         print(item)
#
# print(print_every_number())
# print(print_every_number((1,2,2,3,4,4,10)))
"""
...
"""
# def greet(string_value: str):
#     print(f"Hello, my name is {string_value}")
# greet(24601) # 1. expected string but printed an int
...
"""
def division(num_1:int=2,num_2:int=5) -> float:
    return num_1/num_2
print(division())
"""
